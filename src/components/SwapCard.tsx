        ...
        {tabs.map((tab) => (
          <button
            ...
            className={`px-3.5 py-2 rounded-xl text-[13px] font-semibold transition-all whitespace-nowrap ${
              tab.accent
                ? `bg-gradient-to-r from-[hsl(214,80%,55%)] via-[hsl(270,60%,60%)] to-[hsl(320,70%,60%)] bg-clip-text text-transparent ${activeTab === tab.id ? "shadow-[0_1px_3px_rgba(0,0,0,0.06)]" : ""}`
                : activeTab === tab.id
